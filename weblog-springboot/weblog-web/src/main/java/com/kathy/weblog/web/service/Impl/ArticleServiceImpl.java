...
import com.kathy.weblog.admin.event.ReadArticleEvent;
import com.kathy.weblog.common.domain.dos.*;
import com.kathy.weblog.common.domain.mapper.*;
...
import com.kathy.weblog.web.markdown.MarkdownHelper;
import com.kathy.weblog.web.model.vo.article.*;
import com.kathy.weblog.web.model.vo.category.FindCategoryListRspVO;
import com.kathy.weblog.web.model.vo.tag.FindTagListRspVO;
import com.kathy.weblog.web.service.ArticleService;
    ...
    public Response findArticlePageList(FindIndexArticlePageListReqVO findIndexArticlePageListReqVO) {
        ...
        if (!CollectionUtils.isEmpty(articleDOS)) {
            ...
            vos = articleDOS.stream()
                    .map(articleDO -> ArticleConvert.INSTANCE.convertDO2VO(articleDO)) // 这是第63行，错在哪里？
